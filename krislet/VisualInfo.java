...
class VisualInfo {
    ...
    private static final Pattern p_type = Pattern.compile("^(p|g)$");
    private static final Pattern p_number = Pattern.compile("^\\d{2}$");
    private static final Pattern p_lr = Pattern.compile("^(l|r)$");
    private static final Pattern p_lrc = Pattern.compile("^(l|r|c)$");
}
